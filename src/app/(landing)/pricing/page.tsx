...
const PricingPage = () => {
    ...
    return (
    <div className='bg-fuchsia-50 py-24 sm:py-32'>
        <MaxWidthWrapper>
            ...
            <div className='bg-white mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none'>
                <div className='p-8 sm:p-10 lg:flex-auto'>
                    ...
                    <p className='ml-6 text-base/7 text-gray-600'>
                        Invest once in a PingPanda and transform how you monitor your Saas forever Get Instant alerts, track critical metrics and never miss a beat in u your bussniess growth
                    </p>
                    ...
                    <ul className='mt-8 grid grid-cols-1 gap-4 text-sm/6 text-gray-600 sm:grid-cols-2 sm:gap-6'>
                        {INCLUDED_FEATURES.map((feature,index) => (
                            <li key={index} className='flex gap-3'>
                                <CheckIcon className='h-6 w-5 flex-none text-fuchsia-700'/>
                                {feature}
                            </li>
                        ))}
                    </ul>
                ...
                <div className='-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0'>
                    <div className='rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:justify-center lg:py-16'>
